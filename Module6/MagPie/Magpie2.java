...
public class Magpie2
{
    ...
    public String getResponse(String statement)
    {
        ...
        {
            response = "That sounds very yummy";
        }else if (findKeyword(statement,"long")>=0)
        {
            response = "Whats taking so long";
        }
        ...
        {
            response = "Your teacher seems like quite the neat fellow";
        }
        else
        {
    ...
    private String getRandomResponse()
    {
        ...
        else if (whichResponse == 3)
        {
            ...
            response = "Fun fact I love to code";
        }else if(whichResponse == 4){
