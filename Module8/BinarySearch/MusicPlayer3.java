...
public class MusicPlayer3 {
    public static void main(String[] args) {
        ...
        PrintTable(musicArray, "List of Songs");

        System.out.println("=================================================");

        System.out.println("Songs Searched By Song Title");
        ...
        System.out.println("Songs Searched By Year Created");
        SortInt(musicArray);
        ...
        System.out.println("Songs Searched By Artist Name");
    ...
    public static void PrintTable(Music3[] list, String change) {
        System.out.println("\n\n" + change + "\n");
        System.out.printf("|%-30S | %4S | %20S|%n", "Name", "Year", "Artist");
    ...
    public static void LPtitle(Music3[] r, int low, String toFind) {
        int i;
        int start = low;
        int end = low;
    ...
    public static void LPartist(Music3[] r, int low, String toFind) {
        int i;
        int start = low;
        int end = low;
    ...
    public static void LPyear(Music3[] r, int low, int toFind) {
        int i;
        int start = low;
        int end = low;
    ...
    public static void SortStringArtist(Music3[] array) {
    ...
    public static void SortStringTitle(Music3[] array) {
        int posMax;
        Music3 temp;
        for (int i = array.length - 1; i >= 0; i--) {
            posMax = 0;
    ...
    public static void SortInt(Music3[] array) {
